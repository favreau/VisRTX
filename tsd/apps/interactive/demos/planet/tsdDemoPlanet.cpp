...
class Application : public TSDApplication
{
 public:
  ...
  anari_viewer::WindowArray setupWindows() override
  {
    ...
    auto *planetcontrols = new tsd::demo::PlanetControls(this);
    ...
    windows.emplace_back(planetcontrols);
    ...
    auto populateScene =
        [vp = viewport, vp2 = viewport2, pc = planetcontrols, core = core]() {
          ...
          // Initialize planet controls with loaded scene data
          pc->importPlanetData();
...
{
  {
    ...
    app.run(1920, 1080, "TSD Demo | Planet Visualization");
  }
