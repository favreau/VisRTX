...
class Application : public TSDApplication
{
 public:
  Application(int argc, const char *argv[])
      : TSDApplication(argc, argv), m_argc(argc), m_argv(argv)
  {}
  ...
  anari_viewer::WindowArray setupWindows() override
  {
    ...
    auto *earthcontrols = new tsd::demo::EarthControls(this);
    ...
    windows.emplace_back(earthcontrols);
    ...
    auto populateScene = [this,
      ...
      std::string cloudsFile, magneticFile, planetFile;
      ...
      // Load earth data if all files are specified
  ...
  DockNode        ID=0x00000003 Parent=0x80F5B4C5 SizeRef=1368,1054 Split=X
    DockNode      ID=0x00000001 Parent=0x00000003 SizeRef=547,1105 Split=Y Selected=0xCD8384B1
      DockNode    ID=0x00000008 Parent=0x00000001 SizeRef=547,575 Split=Y Selected=0xCD8384B1
        DockNode  ID=0x0000000D Parent=0x00000008 SizeRef=547,200 Selected=0x8F094A95
...
{
  {
    ...
    app.run(1920, 1080, "TSD Demo | Earth Visualization");
  }
