...
class MessageType(IntEnum):
    ...
    SERVER_SET_CURRENT_RENDERER = 7
    SERVER_SET_CURRENT_CAMERA = 8
    SERVER_SET_ARRAY_DATA = 9
    SERVER_ADD_OBJECT = 10
    SERVER_REMOVE_OBJECT = 11
    SERVER_REMOVE_ALL_OBJECTS = 12
    SERVER_UPDATE_LAYER = 13
    ...
    CLIENT_RECEIVE_VIEW = 19
    CLIENT_RECEIVE_CURRENT_CAMERA = 20
    CLIENT_SCENE_TRANSFER_BEGIN = 21

    # Client → Server: requests
    SERVER_REQUEST_FRAME_CONFIG = 22
    SERVER_REQUEST_VIEW = 23
    SERVER_REQUEST_CURRENT_RENDERER = 24
    SERVER_REQUEST_CURRENT_CAMERA = 25
    SERVER_REQUEST_SCENE = 26
